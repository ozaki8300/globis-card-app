...
export default function Home() {
  ...
  const baseCardClass =
    "border-neutral-700 bg-neutral-900 text-neutral-200 hover:bg-white/5";

  const selectedThoughtClass =
    "border-blue-500/50 bg-neutral-900 shadow-[0_0_0_1px_rgba(59,130,246,0.12)]";
  ...
  const topButtonClass = "rounded-lg border border-neutral-700 px-3 py-2 text-[11pt] text-neutral-200 transition hover:border-neutral-500 hover:bg-white/5 hover:text-white";
  const insertButtonClass = "rounded-lg border border-neutral-700 px-3 py-2 text-[11pt] text-neutral-200 transition hover:border-neutral-500 hover:bg-white/5 hover:text-white";
  const panelButtonClass = "rounded-lg border border-neutral-700 px-3 py-1.5 text-[11pt] text-neutral-300 transition hover:border-neutral-500 hover:bg-white/5 hover:text-white";
    ...
    <main className="min-h-screen bg-neutral-950 text-neutral-100 lg:h-screen lg:overflow-hidden">
      ...
      <header className="flex min-h-[70px] flex-wrap items-center justify-between gap-3 border-b border-neutral-800 px-6 py-3">
        ...
        <div className="hidden flex-wrap items-center justify-end gap-3 lg:flex">
          <span className="text-[11pt] text-neutral-200">✔ {saveStatus}</span>
          ...
          <div className="flex items-center gap-2 rounded-xl border border-neutral-800 bg-neutral-900/60 p-1">
            <button
              ...
              className="rounded-lg border border-neutral-700 px-3 py-2 text-[11pt] text-neutral-200 transition hover:border-neutral-500 hover:bg-white/5 hover:text-white"
            >
              🔄 視点を変える
            </button>
          ...
          <div className="flex items-center gap-2 rounded-xl border border-neutral-800 bg-neutral-900/60 p-1">
            ...
            <button onClick={createShare} className="rounded-lg border border-neutral-700 px-3 py-2 text-[11pt] text-neutral-200 hover:bg-white/5">QR表示</button>
          </div>
        </div>
